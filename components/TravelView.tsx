...
const TravelView: React.FC = () => {
  ...
  const TripMap = () => (
    <div className="bg-white/80 dark:bg-slate-800/60 backdrop-blur-md border border-white/50 dark:border-slate-700/50 hover:border-sky-400 dark:hover:border-indigo-400 rounded-[2rem] p-1.5 shadow-sm relative group overflow-hidden isolate h-[450px] transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-2xl">
      ...
      {activeMarker && (
        <div className="absolute inset-2 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl rounded-[1.7rem] overflow-hidden shadow-2xl animate-scale-in origin-center transition-all duration-300">
            <div className="h-full flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6 md:p-8 flex flex-col relative overflow-y-auto custom-scrollbar">
                    ...
                    <div className="mt-8 flex gap-3 pt-6 border-t border-slate-100 dark:border-slate-800">
                        <button className="flex-1 py-3 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-sm font-bold shadow-lg shadow-sky-600/20 transition-all active:scale-95 flex items-center justify-center gap-2 hover:-translate-y-1 hover:shadow-xl">
                            <Navigation className="w-4 h-4" />
                            Get Directions
                        </button>
                        <button className="px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl text-sm font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors hover:-translate-y-1 hover:shadow-md">
                            Website
                        </button>
                    </div>
                </div>
      ...
      {/* Map Header Overlay */}
      <div className="absolute top-5 left-5 z-20 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-700 px-4 py-2 rounded-xl shadow-lg shadow-black/5 transform transition-all duration-300 hover:scale-105 cursor-default hover:border-sky-300 dark:hover:border-indigo-500 hover:shadow-xl hover:-translate-y-1">
        <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
          <MapPin className="w-4 h-4 text-sky-500 dark:text-indigo-400" />
          Kyoto Central
        </h4>
      </div>

      <div className="absolute top-5 right-5 z-20 flex gap-2">
        <button className="p-2.5 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-700 rounded-xl shadow-lg shadow-black/5 hover:bg-white dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-all active:scale-95 hover:border-sky-300 dark:hover:border-indigo-500 hover:-translate-y-1 hover:shadow-xl">
          <Navigation className="w-4 h-4" />
        </button>
        <button className="p-2.5 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-700 rounded-xl shadow-lg shadow-black/5 hover:bg-white dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-all active:scale-95 hover:border-sky-300 dark:hover:border-indigo-500 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="w-full h-full relative bg-slate-100 dark:bg-slate-800 rounded-[1.7rem] overflow-hidden">
        <img 
          ...
          alt="Map View" 
          className={`w-full h-full object-cover grayscale-[10%] transition-all duration-700 ease-apple ${activeMarker ? 'scale-110 blur-sm' : 'hover:scale-105 opacity-80 dark:opacity-50'}`}
        />
        
        {/* Render Markers */}
        {!activeMarker && markers.map((marker) => {
    ...
    <div className="p-6 md:p-8 w-full mx-auto space-y-10 animate-fade-in-up relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/70 dark:bg-slate-800/40 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 hover:border-emerald-400 dark:hover:border-emerald-400/80 rounded-[2rem] p-7 relative overflow-hidden isolate group hover:bg-white dark:hover:bg-slate-800/60 transition-all duration-300 ease-out shadow-sm hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.01]">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/40 rounded-2xl p-4 flex justify-between items-center border border-slate-100 dark:border-slate-700/50 hover:border-emerald-200 dark:hover:border-emerald-500/30 transition-all hover:bg-white dark:hover:bg-slate-800 hover:shadow-md">
                  ...
                  <button className="text-xs font-bold bg-white dark:bg-slate-700 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 text-slate-700 dark:text-white px-4 py-2.5 rounded-xl transition-all border border-slate-200 dark:border-transparent shadow-sm hover:text-emerald-600 dark:hover:text-emerald-400 hover:border-emerald-200">
                    Get Directions
                  </button>
                </div>
              </div>
        ...
        <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          ...
          {/* AI Suggestion Box */}
          <div className="bg-gradient-to-br from-sky-500 to-blue-600 dark:from-indigo-600 dark:to-violet-900 rounded-[2rem] p-8 relative overflow-hidden shadow-2xl shadow-sky-500/20 dark:shadow-indigo-500/30 group cursor-pointer transition-all duration-300 ease-out border border-transparent hover:border-white/30 hover:scale-[1.03] hover:-translate-y-1 hover:shadow-sky-500/40">
